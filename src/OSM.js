...
import './OSM.css';
import FeaturedLegends from './FeaturedLegends';
  ...
  return (
    ...
    <section className={"map-section-wraper"}>
        ...
        className={`map-OSM-container ${isNightMode ? 'night-mode' : 'day-mode'}`}>
          ...
          <div className='searchAndFeautredDiv'>
            {/* <MapSearchByKeyword legends={this.state.legends} flyToMarker={this.flyToMarker} /> */}
            <FeaturedLegends images={this.state.images} legends={this.state.legends} flyToMarker={this.flyToMarker} />
          </div>
        </div>
