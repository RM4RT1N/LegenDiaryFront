...
decodeToken(token){
  ...
  render(){
    const { sidebarVisible,longitude,latitude,allImages,placesToAccepted} = this.state;
    if (this.token) {
        this.fetchUser();
            ...
            <div className={"app-main-wraper"}>
                ...
                {this.state.userData.id!=null ?
                    <>
                        ...
                        <Edit editToggleSidebar={this.editSidebarClose}images={allImages}legendId={this.state.flyToId}visible={this.state.editLegendOpen}userData={this.state.userData}userID={this.state.userData.id} latitude={latitude} longitude={longitude}/>
                        {this.state.userPanelOpen?<UserPanel placesToAccept={placesToAccepted}open={this.editLegendOpen} fly={this.flyToLegend} show={this.state.userPanelOpen} close={this.userPanelChangeState} userData={this.state.userData}/>
                        :null}
